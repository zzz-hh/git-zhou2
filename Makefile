...
TARGET := //:node \
          //:cli \
          //src/fediux/pybind_warpper:linkcontext \
          //src/fediux/pybind_warpper:opt_paillier_c2py \
          //src/fediux/task/pybind_wrapper:ph_secure_lib \
          //:task_main
...
ifeq ($(protos), y)
    TARGET += //src/fediux/protos:worker_py_pb2_grpc //src/fediux/protos:service_py_pb2_grpc
endif
...
release:
	...
	rm -f fediux-node
	ln -s -f bazel-bin/node fediux-node
