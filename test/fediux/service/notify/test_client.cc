...
class NotifyTestClient {
  public:
    ...
    bool init(const std::string &client_id, const std::string &server) {
        ...
        stub_ = fediux::rpc::NodeService::NewStub(
  ...
  public:
    ...
    std::unique_ptr<fediux::rpc::NodeService::Stub> stub_;
    ::grpc::ClientContext context_{};
    std::unique_ptr<::grpc::ClientReaderInterface<fediux::rpc::NodeEventReply>> stream_{};
