...
git_repository(
  ...
  remote = "https://gitee.com/m13831206695/bazel-rules-thirdparty",
)

http_archive(
  name = "platforms",
  urls = ["https://gitee.com/m13831206695/platforms/releases/download/0.0.6/platforms-0.0.6.tar.gz"],
...
http_archive(
    ...
    urls = [
        "https://github.com/bazelbuild/rules_foreign_cc/archive/refs/tags/0.8.0.tar.gz",
        "https://primihub.oss-cn-beijing.aliyuncs.com/rules_foreign_cc-0.8.0.tar.gz",
    ],
)
...
git_repository(
    ...
    branch = "master",
    remote = "https://gitee.com/m13831206695/rules_boost.git",
)
