...
def submit_mpc_task():
    ...
    generator.set_input_output("/home/fediux/expr/party_0.csv", filename)
    ...
    generator.set_input_output("/home/fediux/expr/party_1.csv", filename)
    ...
    generator.set_input_output("/home/fediux/expr/party_2.csv", filename)
