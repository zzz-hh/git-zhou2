...
from src.fediux.protos import service_pb2, service_pb2_grpc  # noqa
...
class NodeServiceClient(GRPCConnect):
    # """fediux gRPC node context service client.

    # :return: A fediux gRPC node context service client.
    # """
...
class DataServiceClient(GRPCConnect):
    """fediux gRPC data service client.

    :return: A fediux gRPC data service client.
    """
