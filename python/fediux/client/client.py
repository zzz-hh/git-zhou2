...
from fediux.client.ph_grpc.grpc_client import GrpcClient
from fediux.client.ph_grpc.service import NodeServiceClient
from fediux.client.visitor import Visitor
from fediux.utils.async_util import fire_coroutine_threadsafe
...
class FediuxClient(object):
    """Fediux Python SDK Client."""
    __instance = None
    __first_init = False
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if not self.__first_init:
            FediuxClient.__first_init = True
        ...
        # Storage
        self.tasks_map = {}  # Fediux task map task_id: Task
    ...
    async def submit_task(self, job_id, client_id, *args):
        ...
        task = Task(task_id="task:" + uuid.uuid5(uuid.NAMESPACE_DNS,
                                                 'python.org').hex, fediux_client=self)
