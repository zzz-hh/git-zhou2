...
from .plaintext_server import Plaintext_Server as MLP_Plaintext_Server
from .plaintext_server import DPSGD_Server as MLP_DPSGD_Server

class minidiffusionServer(BaseModel):
    ...
    def run(self):
        ...
        logger.info(f"Running Horizontal Diffusion algorithm, role={role_name}, process={process}")
    ...
    def train(self):
        ...
        logger.info(f"Using {device} device11111")
