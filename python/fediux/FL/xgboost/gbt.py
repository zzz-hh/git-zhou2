...
from fediux.primitive.opt_paillier_c2py_warpper import opt_paillier_decrypt_crt, opt_paillier_encrypt_crt, \
    opt_paillier_add, opt_paillier_keygen
from fediux.utils.logger_util import FLConsoleHandler, FORMAT
...
class VGBTHost(VGBTBase):
    ...
    def fit(self):
        ...
        self.channel.send("xgb_pub", self.pub)
        logger.info("***"*150)
        logger.info("iter={}".format(self.estimators))
        logger.info("***"*150)
