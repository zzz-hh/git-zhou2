...
from fediux.FL.utils.dataset import ChineseTextDataset
...
class TextCNNClient(BaseModel):
    ...
    def train(self):
        ...
        if method == 'Plaintext':
            client = Plaintext_TextCNN_Client(x, y,
                                      method,
                                      device,
                                      self.common_params,
                                      server_channel,
...
class Plaintext_TextCNN_Client:
    ...
    def __init__(self, x, y, method, device,common_params,
        ...
        num_filters = common_params["num_filters"]
        ...
        self.model = create_model(method, vocab_size, embedding_dim, num_filters, dropout, self.output_dim, device)
