...
def test_fl_local():
    ...
    os.chdir(path)
    command = "./bazel-bin/cli --task_lang=python --server=127.0.0.1:50050  --task_code='./python/fediux/examples/disxgb_en.py' --params='predictFileName:STRING:0:/data/result/prediction.csv,indicatorFileName:STRING:0:/data/result/indicator.csv'"
