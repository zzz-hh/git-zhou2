#ifndef SRC_FEDIUX_SERVICE_DATASET_MODEL_H_
#define SRC_FEDIUX_SERVICE_DATASET_MODEL_H_
...
#include "src/fediux/util/arrow_wrapper_util.h"
...
class DatasetMeta {
 public:
  ...
  DatasetMeta(const std::shared_ptr<fediux::Dataset> &dataset,
...
#endif  // SRC_FEDIUX_SERVICE_DATASET_MODEL_H_
