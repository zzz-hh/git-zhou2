...
#ifndef SRC_FEDIUX_SERVICE_DATASET_META_SERVICE_GRPC_IMPL_H_
#define SRC_FEDIUX_SERVICE_DATASET_META_SERVICE_GRPC_IMPL_H_
#include <grpc/grpc.h>
...
#endif  // SRC_FEDIUX_SERVICE_DATASET_META_SERVICE_GRPC_IMPL_H_
