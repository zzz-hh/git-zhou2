...
#include "src/fediux/task/language/factory.h"
#include "src/fediux/task/semantic/parser.h"
...
#include "src/fediux/util/hash.h"
...
void VMNodeImpl::ReportAliveInfoThread() {
  report_alive_info_fut_ = std::async(
    ...
    [&]() -> void {
      ...
      std::string url = "https://node1.fediux.com/collect/operate/addNode";
