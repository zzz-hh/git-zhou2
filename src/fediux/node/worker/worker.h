#ifndef SRC_FEDIUX_NODE_WORKER_WORKER_H_
#define SRC_FEDIUX_NODE_WORKER_WORKER_H_
...
class Worker {
 public:
  ...
  std::shared_ptr<fediux::task::TaskBase> getTask() {
    return task_ptr;
  }
 ...
 private:
  ...
  std::shared_ptr<fediux::task::TaskBase> task_ptr{nullptr};
...
#endif  // SRC_FEDIUX_NODE_WORKER_WORKER_H_
