...
#include "src/fediux/common/eventbus/function_traits.hpp"
...
class handler_registration {
    ...
    fediux::common::event_bus *event_bus_{nullptr};
  ...
  protected:
    handler_registration(const void *handle, fediux::common::event_bus *bus);
...
class event_bus {
  public:
    ...
    register_handler(EventHandler &&handler) {
        using traits = fediux::common::function_traits<EventHandler>;
    ...
    register_handler(ClassType *class_instance,
        ...
        using traits = fediux::common::function_traits<MemberFunction>;
