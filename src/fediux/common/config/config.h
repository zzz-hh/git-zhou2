#ifndef SRC_FEDIUX_COMMON_CONFIG_CONFIG_H_
#define SRC_FEDIUX_COMMON_CONFIG_CONFIG_H_
...
namespace YAML {
using Dataset = fediux::common::Dataset;
using LocalKV = fediux::common::LocalKV;
using P2P = fediux::common::P2P;
using NodeConfig = fediux::common::NodeConfig;
using DBInfo = fediux::common::DBInfo;
// using ServerConfig = fediux::Node;
using ServerInfo = fediux::common::ServerInfo;
using CertificateConfig = fediux::common::CertificateConfig;
using RedisConfig = fediux::common::RedisConfig;
using Tee = fediux::common::Tee;
...
#endif  // SRC_FEDIUX_COMMON_CONFIG_CONFIG_H_
