#ifndef SRC_FEDIUX_TASK_SEMANTIC_SCHEDULER_FACTORY_H_
#define SRC_FEDIUX_TASK_SEMANTIC_SCHEDULER_FACTORY_H_
#include <memory>
#include "src/fediux/task/semantic/scheduler/scheduler.h"
#include "src/fediux/task/semantic/scheduler/aby3_scheduler.h"
#include "src/fediux/task/semantic/scheduler/fl_scheduler.h"
#include "src/fediux/task/semantic/scheduler/mpc_scheduler.h"
#include "src/fediux/task/semantic/scheduler/tee_scheduler.h"
...
#endif  // SRC_FEDIUX_TASK_SEMANTIC_SCHEDULER_FACTORY_H_
