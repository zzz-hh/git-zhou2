...
using EndPoint = fediux::rpc::EndPoint;
using LinkType = fediux::rpc::LinkType;
using ParamValue = fediux::rpc::ParamValue;
using TaskType = fediux::rpc::TaskType;
using VirtualMachine = fediux::rpc::VirtualMachine;
using VarType = fediux::rpc::VarType;
