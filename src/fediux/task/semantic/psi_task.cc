...
#include "src/fediux/util/endian_util.h"
#include "src/fediux/common/value_check_util.h"
#include "src/fediux/kernel/psi/operator/factory.h"
...
retcode PsiTask::InitOperator() {
  auto type = static_cast<fediux::psi::PsiType>(psi_type_);
  this->psi_operator_ =
      fediux::psi::Factory::Create(type, options_, tee_executor_);
