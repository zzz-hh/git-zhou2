...
#include "src/fediux/kernel/pir/operator/factory.h"
...
retcode PirTask::InitOperator() {
  auto type = static_cast<fediux::pir::PirType>(pir_type_);
  this->operator_ = fediux::pir::Factory::Create(type, options_);
