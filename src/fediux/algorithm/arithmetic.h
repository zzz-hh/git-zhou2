...
#ifndef SRC_FEDIUX_ALGORITHM_ARITHMETIC_H_
#define SRC_FEDIUX_ALGORITHM_ARITHMETIC_H_
#include <stdlib.h>
#include <time.h>
#include <algorithm>
#include <iostream>
...
#include "src/fediux/executor/express.h"
...
//       std::function<std::shared_ptr<network::IChannel>(fediux::Node &node)>;    // NOLINT
...
//   // std::map<uint16_t, fediux::Node> partyid_node_map_;

//   // uint16_t local_party_id_;
//   // uint16_t next_party_id_;
//   // uint16_t prev_party_id_;

//   // fediux::Node local_node_;
// };
// #endif

}  // namespace fediux
#endif  // SRC_FEDIUX_ALGORITHM_ARITHMETIC_H_
