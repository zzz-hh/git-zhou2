#ifndef SRC_fediux_UTIL_NETWORK_SOCKET_COMMON_TIMER_H_
#define SRC_fediux_UTIL_NETWORK_SOCKET_COMMON_TIMER_H_
...
#endif  // SRC_fediux_UTIL_NETWORK_SOCKET_COMMON_TIMER_H_
