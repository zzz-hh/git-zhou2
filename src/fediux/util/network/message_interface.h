#ifndef SRC_FEDIUX_UTIL_NETWORK_MESSAGE_INTERFACE_H_
#define SRC_FEDIUX_UTIL_NETWORK_MESSAGE_INTERFACE_H_
#include <string>
#include <queue>
#include <memory>
#include <atomic>
...
#endif  // SRC_FEDIUX_UTIL_NETWORK_MESSAGE_INTERFACE_H_
