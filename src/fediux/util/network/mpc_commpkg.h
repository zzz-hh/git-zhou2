#ifndef SRC_FEDIUX_UTIL_NETWORK_MPC_COMMPKG_H_
#define SRC_FEDIUX_UTIL_NETWORK_MPC_COMMPKG_H_

#include <string>
#include <unordered_map>

#include "src/fediux/util/network/mpc_channel.h"
namespace fediux {
struct CommPkgBase {
  CommPkgBase();
...
#endif  // SRC_FEDIUX_UTIL_NETWORK_MPC_COMMPKG_H_
