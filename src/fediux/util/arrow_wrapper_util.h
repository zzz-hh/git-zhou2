#ifndef SRC_FEDIUX_UTIL_ARROW_WRAPPER_UTIL_H_
#define SRC_FEDIUX_UTIL_ARROW_WRAPPER_UTIL_H_
#include <memory>
#include <string>
#include <vector>
#include "arrow/api.h"
...
namespace fediux::arrow_wrapper::util {
/**
...
#endif  // SRC_FEDIUX_UTIL_ARROW_WRAPPER_UTIL_H_
