#ifndef SRC_FEDIUX_KERNEL_PSI_OPERATOR_KKRT_PSI_H_
#define SRC_FEDIUX_KERNEL_PSI_OPERATOR_KKRT_PSI_H_
#include <vector>
#include <map>
#include <memory>
#include <string>
...
using TaskMessagePassInterface = fediux::network::TaskMessagePassInterface;
...
#endif  // SRC_FEDIUX_KERNEL_PSI_OPERATOR_KKRT_PSI_H_
