#ifndef SRC_FEDIUX_KERNEL_PSI_OPERATOR_FACTORY_H_
#define SRC_FEDIUX_KERNEL_PSI_OPERATOR_FACTORY_H_
#include <memory>
#include "src/fediux/kernel/psi/operator/common.h"
#include "src/fediux/kernel/psi/operator/base_psi.h"
#include "src/fediux/kernel/psi/operator/kkrt_psi.h"
#include "src/fediux/kernel/psi/operator/ecdh_psi.h"
#ifdef SGX
#include "src/fediux/kernel/psi/operator/tee_psi.h"
#endif  // SGX
...
#endif  // SRC_FEDIUX_KERNEL_PSI_OPERATOR_FACTORY_H_
